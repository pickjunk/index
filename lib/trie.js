...
exports.Token = exports.Node = void 0;
...
function cutter() {
    ...
    // 分词
    function cut(text, exceptSelf = false) {
                    ...
                    for (let c of children) {
                        ...
                        for (let a of synonyms) {
                            for (let b of c.synonyms) {
                                ...
                                cartesian.add(new Token([...a.units, ...b.units], token.freq, token.pos));
                            }
                        }
                        synonyms = cartesian;
                    }
